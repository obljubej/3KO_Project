###########################################################################
## Makefile generated for Simulink model 'project_model_UPDATE'. 
## 
## Makefile     : project_model_UPDATE.mk
## Generated on : Fri Nov 21 16:25:28 2025
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/project_model_UPDATE.elf
...
PRODUCT_NAME              = project_model_UPDATE
MAKEFILE                  = project_model_UPDATE.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/justi/OneDrive/Desktop/3K/3KO_Project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = project_model_UPDATE_comp.rsp
CMD_FILE                  = project_model_UPDATE.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/project_model_UPDATE.elf
...
DEFINES_STANDARD = -DMODEL=project_model_UPDATE -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o i2c_api.o MW_I2C.o project_model_UPDATE.o project_model_UPDATE_data.o project_model_UPDATE_tgtconn.o rtGetInf.o rtGetNaN.o rt_nonfinite.o updown.o ext_work.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o k64f_rtiostream_interface.o k64f_rtiostream_commservice.o k64f_ext_svr.o k64f_rtiostream_utils.o tgtSvc_UARTInfo.o
...
%.o : $(START_DIR)/project_model_UPDATE_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/project_model_UPDATE_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/project_model_UPDATE_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/project_model_UPDATE_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/project_model_UPDATE_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/project_model_UPDATE_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


project_model_UPDATE.o : $(START_DIR)/project_model_UPDATE_ert_rtw/project_model_UPDATE.c
	$(CC) $(CFLAGS) -o "$@" "$<"


project_model_UPDATE_data.o : $(START_DIR)/project_model_UPDATE_ert_rtw/project_model_UPDATE_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


project_model_UPDATE_tgtconn.o : $(START_DIR)/project_model_UPDATE_ert_rtw/project_model_UPDATE_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/project_model_UPDATE_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/project_model_UPDATE_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/project_model_UPDATE_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
