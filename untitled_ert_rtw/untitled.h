...
typedef struct {
  ...
  uint32_T is_c1_untitled;             /* '<Root>/Parameter_Definitions' */
  uint32_T is_c3_untitled;             /* '<Root>/Pacemaker_States' */
  ...
  uint32_T is_c6_untitled;             /* '<Root>/Chart1' */
  uint32_T temporalCounter_i1_a;       /* '<Root>/Chart1' */
  uint8_T is_active_c1_untitled;       /* '<Root>/Parameter_Definitions' */
  uint8_T is_active_c3_untitled;       /* '<Root>/Pacemaker_States' */
  uint8_T is_active_c6_untitled;       /* '<Root>/Chart1' */
} DW_untitled_T;
 ...
 * '<Root>' : 'untitled'
 * '<S1>'   : 'untitled/Chart1'
 * '<S2>'   : 'untitled/Input_Subsystem'
 * '<S3>'   : 'untitled/Output_Subsystem'
 * '<S4>'   : 'untitled/Pacemaker_States'
 * '<S5>'   : 'untitled/Parameter_Definitions'
 * '<S6>'   : 'untitled/Rate_Adaptive_Subsystem1'
 * '<S7>'   : 'untitled/Rate_Adaptive_Subsystem1/Multiply-Add'
 */
